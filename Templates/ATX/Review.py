...
class Review(object):
    ...
    # Steuerzeichen entfernen, bis auf Zeilenumbrüche \x0A, die müssen erhalten bleiben
    FIND_ASCII_CTRL_REG_EXP = re.compile(r'([\x00-\x09]|[\x0B-\x1F])+')
    ...
    def AddReviewTag(self, tag):
        ...
        @param tag: Review-Tag der hinzugefügt werden soll.
        @type tag: str
        '''
    ...
    def SetSummary(self, summary):
        '''
        Setzt die Summary dieses Reviews.
    ...
    def GetSummary(self):
        '''
        :return: Die Summary dieses Reviews
        '''
    ...
    def GetXml(self):
        ...
        if self.__summary:
            etree.SubElement(review, u'SUMMARY').text = self.__summary
        ...
        etree.SubElement(review, u'COMMENT').text = etree.CDATA(str(self.__comment))
