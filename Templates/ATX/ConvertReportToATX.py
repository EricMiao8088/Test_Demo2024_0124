...
class ConvertReportToATX(object):
    ...
    def CreateATXXmlFile(self, xmlFilePath):
        ...
        '''
        d2x = dict2xml(self.__reportTrfFile, self.__version, self.__data.atxReport)
    ...
    def __GetXML(self):
        ...
        @rtype: str
        '''
        return dict2xml(self.__reportTrfFile, self.__version, self.__data.atxReport).GetXmlString()
    ...
    def __GetJSON(self):
        ...
        @rtype: str
        '''
        return json.dumps(self.__data.atxReport)
    ...
    def GetFiles(self):
        ...
        @rtype: list[->str]
        '''
        return self.__data.archiveFiles

    def GetAtxTestCaseReferences(self):
        '''
        Gibt die Liste der ATX Testcase Referenzen zurück um z.B. archiveMiscFiles diesen
        TestCases zuweisen zu können.
        @return: Menge der Referenzen.
        @rtype: set[->str]
        '''
        return self.__data.reportRefPaths
    ...
    def GetReviews(self):
        ...
        @rtype: list[->Review]
        '''
        return self.__data.reviews

    def GetTraceFiles(self):
        '''
        @return: Liste der Trace-Dateien.
        @rtype: list[str]
        '''
        return self.__data.traceFiles
