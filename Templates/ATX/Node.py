...
class Node(object):
    ...
    def GetList(self):
        ...
        for each in self.__subNodes:
            ...
            # Beschreibung von TestSteps übernehmen
            if u'DESC' in each.GetData() and each.GetData()[u'DESC']:
                testStep[u'DESC'] = each.GetData()[u'DESC']

            # Verdict Definition nur in die TestSpec übernehmen.
            if u'VERDICT-DEFINITION' in each.GetData() and each.GetData()[u'VERDICT-DEFINITION']:
