...
class RetryingTgRequestServiceTest(unittest.TestCase):
    ...
    def testPerformHealthCheckedRequest(self, patched_get):
        ...
        # ACT
        actual = subject.PerformHealthCheckedRequest(baseUrl, proxies, responder.GetNextReponse)

        # ASSERT
        self.assertEqual(actual, response)
        patched_get.assert_called_with(baseUrl + "/api/health/ready", verify=False, proxies=proxies)
