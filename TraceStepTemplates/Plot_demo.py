...
class Plot_demo(NumpyBasedTraceStep):
    """
    ...
    def GetSignals(cls):
        ...
        return [
            ...
            SignalDefinition("Signal_3", "IN", optional=False, description=""),
    ...
    def GetParameters(cls):
        ...
        """
        return [ParameterDefinition("plot_count", "IN", description="")]
    ...
    def Process(self, parameters, report, timeAxis, ranges, signals):
        ...
        s3 = signals["Signal_2"]
        s4 = signals["Signal_3"]
        plt_count = parameters["plot_count"]
        for triggerRange in ranges:
            ...
            s3_value = signals["Signal_2"].GetValues().tolist()
            s4_value = s4.GetValues().tolist()
            print(s1_value)
            print(s2_value)
            print(s3_value)
            plt.plot(s1_value,s2_value)
            plt.plot(s1_value,s3_value)
            plt.plot(s2_value,s4_value)
            plt.savefig(r'C:\ET2023_4\2_ECU-TEST_Advanced\Images\test.png')
            '''
            将图片添加到报告中
            '''
            report.Image(r'C:\ET2023_4\2_ECU-TEST_Advanced\Images\test.png',name='test',title='picture',embedded=True,limitPreviewSize=True)
